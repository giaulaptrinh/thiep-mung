...
const contentCard = 'Chúc bạn 20/10 tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với bạn trong hôm nay và cả những ngày sau';
...
const giftImage = 'hot-girl.png.ipg';
const base64 = '';
